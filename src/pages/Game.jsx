        ...
        <div className='lg:mx-24 lg:mb-24 mb-10'>
            ...
            <div>
                ...
                <div className='flex justify-between mb-4 mx-4 text-sm md:mx-10 md:text-md'>
                    <h2 className='text-[#eeeeee]'><a className='flex' href={details.website}>Visit Website <BiLinkExternal/> </a></h2>
                    <h2 className='text-[#eeeeee]'> Release Date: {details.released}</h2>
